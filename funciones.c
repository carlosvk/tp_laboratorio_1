 ...
 * \param resultado int* resultado pasado por referencia si se cumple la funcion.
 * \return int 0 si cumple condicion, -1 si no cumple. Error overflow.
 *
 */
 ...
 *
 * \param num1 float Primer numero a dividir
 * \param num2 float Numero ingresado para dividir.
 * \param resultado float* Resultado pasado por referencia.
 * \return int -1 error overflow, 0 todo ok.
 *
 */
